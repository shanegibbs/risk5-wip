...
fn build_matchers<M: Memory>() -> Vec<Matcher<M>> {
    ...
    vec![
        ...
        Matcher::new(0x707f, 0x6013, |p, _| {
            panic!(format!("Unimplemented insn 'ori' at {:x}", p.pc()))
        }),
        Matcher::new(0x707f, 0x7013, |p, _| {
            panic!(format!("Unimplemented insn 'andi' at {:x}", p.pc()))
        }),
        ...
        Matcher::new(0xfe00707f, 0x4000003b, |p, _| {
            panic!(format!("Unimplemented insn 'subw' at {:x}", p.pc()))
        }),
