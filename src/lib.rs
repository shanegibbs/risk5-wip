...
fn build_matchers<M: Memory>() -> Vec<Matcher<M>> {
    vec![
        ...
        Matcher::new(0x707f, 0x1b, |p,_| panic!(format!("Unimplemented insn 'addiw' at {:x}", p.pc()))),
        ...
        Matcher::new(0x707f, 0x2023, |p,_| panic!(format!("Unimplemented insn 'sw' at {:x}", p.pc()))),
        ...
        Matcher::new(0xffffffff, 0x73, |p,_| panic!(format!("Unimplemented insn 'ecall' at {:x}", p.pc()))),
        ...
        Matcher::new(0xffffffff, 0x30200073, |p,_| panic!(format!("Unimplemented insn 'mret' at {:x}", p.pc()))),
